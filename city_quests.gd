...
func get_world_map_bbcode() -> String:
	...
	t += "[i]Пока карта открыта — весь мир на паузе, урон к тебе не идёт. M / Esc — закрыть. Лавка — Tab или киоск.[/i]\n\n"
	t += "[b]Ориентиры[/b]\n"
	t += "• [color=#deb887]Особняк[/color] — центр арены (деревянный пол, въезд с юга).\n"
	t += "• [color=#8fbc8f]Деревня NPC[/color] — за [b]каменной стеной[/b]; снаружи плита + рычаг; [b]внутри[/b] рычаг закрывает/открывает внутренний проём — при открытии снимается и [b]внешняя[/b] заслонка.\n"
