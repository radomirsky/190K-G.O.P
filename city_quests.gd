...
func get_world_map_bbcode() -> String:
	...
	t += "[i]Пока карта открыта — весь мир на паузе, урон к тебе не идёт. M / Esc — закрыть карту; P — скрыть/показать этот текст и подсказки. Магазин — Tab или лавка в деревне.[/i]\n\n"
	t += "[b]Ориентиры[/b]\n"
