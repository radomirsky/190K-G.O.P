...
func get_world_map_bbcode() -> String:
	...
	t += "• [color=#8fbc8f]Деревня NPC[/color] — за [b]каменной стеной[/b]; проход: снаружи плита + рычаг, [b]внутри деревни[/b] второй рычаг закрывает/открывает внутренние ворота (E сколько угодно).\n"
